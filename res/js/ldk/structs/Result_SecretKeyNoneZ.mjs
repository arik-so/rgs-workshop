...
export class Result_SecretKeyNoneZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_SecretKeyNoneZ_ok(bindings.encodeUint8Array(bindings.check_arr_len(o, 32)));
    ...
    static constructor_err() {
        const ret = bindings.CResult_SecretKeyNoneZ_err();
        const ret_hu_conv = Result_SecretKeyNoneZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_SecretKeyNoneZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_SecretKeyNoneZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_SecretKeyNoneZ_clone(this.ptr);
        const ret_hu_conv = Result_SecretKeyNoneZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_SecretKeyNoneZ_OK extends Result_SecretKeyNoneZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_SecretKeyNoneZ_get_ok(ptr);
...
//# sourceMappingURL=Result_SecretKeyNoneZ.mjs.map