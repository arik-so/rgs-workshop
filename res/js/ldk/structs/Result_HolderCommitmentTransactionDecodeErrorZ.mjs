...
export class Result_HolderCommitmentTransactionDecodeErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_HolderCommitmentTransactionDecodeErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_HolderCommitmentTransactionDecodeErrorZ_err(e == null ? 0n : CommonBase.get_ptr_of(e));
        const ret_hu_conv = Result_HolderCommitmentTransactionDecodeErrorZ.constr_from_ptr(ret);
