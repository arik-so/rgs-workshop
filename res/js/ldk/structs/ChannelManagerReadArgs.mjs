...
export class ChannelManagerReadArgs extends CommonBase {
     ...
     */
    get_keys_manager() {
        const ret = bindings.ChannelManagerReadArgs_get_keys_manager(this.ptr);
