...
export class Result_NoneChannelMonitorUpdateErrZ extends CommonBase {
    ...
    static constructor_ok() {
        const ret = bindings.CResult_NoneChannelMonitorUpdateErrZ_ok();
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_NoneChannelMonitorUpdateErrZ_err(e);
        const ret_hu_conv = Result_NoneChannelMonitorUpdateErrZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_NoneChannelMonitorUpdateErrZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_NoneChannelMonitorUpdateErrZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_NoneChannelMonitorUpdateErrZ_clone(this.ptr);
        const ret_hu_conv = Result_NoneChannelMonitorUpdateErrZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
