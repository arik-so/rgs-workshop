...
export class Persist extends CommonBase {
    ...
    static new_impl(arg) {
        ...
        let structImplementation = {
            persist_new_channel(channel_id, data, update_id) {
                const channel_id_hu_conv = new OutPoint(null, channel_id);
                CommonBase.add_ref_from(channel_id_hu_conv, this);
                const data_hu_conv = new ChannelMonitor(null, data);
                const update_id_hu_conv = new MonitorUpdateId(null, update_id);
     ...
     */
    persist_new_channel(channel_id, data, update_id) {
        const ret = bindings.Persist_persist_new_channel(this.ptr, channel_id == null ? 0n : CommonBase.get_ptr_of(channel_id), data == null ? 0n : CommonBase.get_ptr_of(data), update_id == null ? 0n : CommonBase.get_ptr_of(update_id));
     ...
     */
    update_persisted_channel(channel_id, update, data, update_id) {
        const ret = bindings.Persist_update_persisted_channel(this.ptr, channel_id == null ? 0n : CommonBase.get_ptr_of(channel_id), update == null ? 0n : CommonBase.get_ptr_of(update), data == null ? 0n : CommonBase.get_ptr_of(data), update_id == null ? 0n : CommonBase.get_ptr_of(update_id));
        const ret_hu_conv = Result_NoneChannelMonitorUpdateErrZ.constr_from_ptr(ret);
        CommonBase.add_ref_from(this, channel_id);
