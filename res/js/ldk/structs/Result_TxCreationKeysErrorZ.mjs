...
export class Result_TxCreationKeysErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_TxCreationKeysErrorZ_ok(o == null ? 0n : CommonBase.get_ptr_of(o));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_TxCreationKeysErrorZ_err(e);
        const ret_hu_conv = Result_TxCreationKeysErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_TxCreationKeysErrorZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_TxCreationKeysErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_TxCreationKeysErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_TxCreationKeysErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_TxCreationKeysErrorZ_OK extends Result_TxCreationKeysErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_TxCreationKeysErrorZ_get_ok(ptr);
