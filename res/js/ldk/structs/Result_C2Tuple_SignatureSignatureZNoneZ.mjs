...
export class Result_C2Tuple_SignatureSignatureZNoneZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_C2Tuple_SignatureSignatureZNoneZ_ok(o != null ? CommonBase.get_ptr_of(o) : 0n);
    ...
    static constructor_err() {
        const ret = bindings.CResult_C2Tuple_SignatureSignatureZNoneZ_err();
        const ret_hu_conv = Result_C2Tuple_SignatureSignatureZNoneZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_C2Tuple_SignatureSignatureZNoneZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_C2Tuple_SignatureSignatureZNoneZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_C2Tuple_SignatureSignatureZNoneZ_clone(this.ptr);
        const ret_hu_conv = Result_C2Tuple_SignatureSignatureZNoneZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_C2Tuple_SignatureSignatureZNoneZ_OK extends Result_C2Tuple_SignatureSignatureZNoneZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_C2Tuple_SignatureSignatureZNoneZ_get_ok(ptr);
        const res_hu_conv = new TwoTuple_SignatureSignatureZ(null, res);
...
//# sourceMappingURL=Result_C2Tuple_SignatureSignatureZNoneZ.mjs.map