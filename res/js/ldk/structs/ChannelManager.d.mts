...
export declare class ChannelManager extends CommonBase {
     ...
     */
    static constructor_new(fee_est: FeeEstimator, chain_monitor: Watch, tx_broadcaster: BroadcasterInterface, logger: Logger, keys_manager: KeysInterface, config: UserConfig, params: ChainParameters): ChannelManager;
    /**
     ...
     */
    create_channel(their_network_key: Uint8Array, channel_value_satoshis: bigint, push_msat: bigint, user_channel_id: bigint, override_config: UserConfig): Result__u832APIErrorZ;
    /**
     ...
     */
    close_channel(channel_id: Uint8Array, counterparty_node_id: Uint8Array): Result_NoneAPIErrorZ;
    /**
     * Begins the process of closing a channel. After this call (plus some timeout), no new HTLCs
     * will be accepted on the given channel, and after additional timeout/the closing of all
     * pending HTLCs, the channel will be closed on chain.
     ...
     * [`Normal`]: crate::chain::chaininterface::ConfirmationTarget::Normal
     */
    close_channel_with_target_feerate(channel_id: Uint8Array, counterparty_node_id: Uint8Array, target_feerate_sats_per_1000_weight: number): Result_NoneAPIErrorZ;
    /**
     ...
     * channel.
     */
    force_close_broadcasting_latest_txn(channel_id: Uint8Array, counterparty_node_id: Uint8Array): Result_NoneAPIErrorZ;
    /**
     ...
     */
    force_close_without_broadcasting_txn(channel_id: Uint8Array, counterparty_node_id: Uint8Array): Result_NoneAPIErrorZ;
    /**
     * Force close all channels, immediately broadcasting the latest local commitment transaction
     * for each to the chain and rejecting new HTLCs on each.
     */
    force_close_all_channels_broadcasting_latest_txn(): void;
    /**
     * Force close all channels rejecting new HTLCs on each but without broadcasting the latest
     * local transaction(s).
     */
    force_close_all_channels_without_broadcasting_txn(): void;
    /**
     ...
     */
    send_spontaneous_payment(route: Route, payment_preimage: Uint8Array): Result_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ;
    /**
     * Send a payment that is probing the given route for liquidity. We calculate the
     * [`PaymentHash`] of probes based on a static secret and a random [`PaymentId`], which allows
     * us to easily discern them from real payments.
     */
    send_probe(hops: RouteHop[]): Result_C2Tuple_PaymentHashPaymentIdZPaymentSendFailureZ;
    /**
     ...
     */
    funding_transaction_generated(temporary_channel_id: Uint8Array, counterparty_node_id: Uint8Array, funding_transaction: Uint8Array): Result_NoneAPIErrorZ;
    /**
     ...
     */
    update_channel_config(counterparty_node_id: Uint8Array, channel_ids: Uint8Array[], config: ChannelConfig): Result_NoneAPIErrorZ;
    /**
     ...
     */
    accept_inbound_channel(temporary_channel_id: Uint8Array, counterparty_node_id: Uint8Array, user_channel_id: bigint): Result_NoneAPIErrorZ;
    /**
     ...
     * [`Event::ChannelClosed::user_channel_id`]: events::Event::ChannelClosed::user_channel_id
     */
    accept_inbound_channel_from_trusted_peer_0conf(temporary_channel_id: Uint8Array, counterparty_node_id: Uint8Array, user_channel_id: bigint): Result_NoneAPIErrorZ;
    /**
     ...
     * [`create_inbound_payment_for_hash`]: Self::create_inbound_payment_for_hash
     */
    create_inbound_payment(min_value_msat: Option_u64Z, invoice_expiry_delta_secs: number): Result_C2Tuple_PaymentHashPaymentSecretZNoneZ;
    /**
     ...
     * [`create_inbound_payment`]: Self::create_inbound_payment
     */
    create_inbound_payment_legacy(min_value_msat: Option_u64Z, invoice_expiry_delta_secs: number): Result_C2Tuple_PaymentHashPaymentSecretZAPIErrorZ;
    /**
     ...
     * [`PaymentReceived`]: events::Event::PaymentReceived
     */
    create_inbound_payment_for_hash(payment_hash: Uint8Array, min_value_msat: Option_u64Z, invoice_expiry_delta_secs: number): Result_PaymentSecretNoneZ;
    /**
     ...
     * [`create_inbound_payment_for_hash`]: Self::create_inbound_payment_for_hash
     */
    create_inbound_payment_for_hash_legacy(payment_hash: Uint8Array, min_value_msat: Option_u64Z, invoice_expiry_delta_secs: number): Result_PaymentSecretAPIErrorZ;
    /**
     ...
     * [`create_inbound_payment`]: Self::create_inbound_payment
     */
    get_payment_preimage(payment_hash: Uint8Array, payment_secret: Uint8Array): Result_PaymentPreimageAPIErrorZ;
    /**
