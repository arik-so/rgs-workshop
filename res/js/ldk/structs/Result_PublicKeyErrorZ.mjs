...
export class Result_PublicKeyErrorZ extends CommonBase {
    ...
    static constructor_ok(o) {
        const ret = bindings.CResult_PublicKeyErrorZ_ok(bindings.encodeUint8Array(bindings.check_arr_len(o, 33)));
    ...
    static constructor_err(e) {
        const ret = bindings.CResult_PublicKeyErrorZ_err(e);
        const ret_hu_conv = Result_PublicKeyErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
    /**
     ...
     */
    is_ok() {
        const ret = bindings.CResult_PublicKeyErrorZ_is_ok(this.ptr);
        return ret;
    }
    clone_ptr() {
        const ret = bindings.CResult_PublicKeyErrorZ_clone_ptr(this.ptr);
        return ret;
    }
    /**
     ...
     */
    clone() {
        const ret = bindings.CResult_PublicKeyErrorZ_clone(this.ptr);
        const ret_hu_conv = Result_PublicKeyErrorZ.constr_from_ptr(ret);
        return ret_hu_conv;
    }
}
export class Result_PublicKeyErrorZ_OK extends Result_PublicKeyErrorZ {
    ...
    constructor(_dummy, ptr) {
        super(_dummy, ptr);
        const res = bindings.CResult_PublicKeyErrorZ_get_ok(ptr);
